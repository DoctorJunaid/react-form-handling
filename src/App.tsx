            ...
            <div className={"max-w-screen min-h-screen flex justify-center items-center bg-[#605A71] text-white"}>
                ...
                {/*    Heading and paragraph*/}
                    ...
                    <div className={"flex gap-4 mt-4 mb-4 md:mb-4 mx-auto w-11/12"}>
                        <input name={"FirstName"} required={true} type={"text"} placeholder={"First Name "} className={"border-none bg-[#3C364C] w-1/2 p-2  rounded-md text-sm md:text-base placeholder:text-[#7F7B89]"}/>
                        <input name={"LastName"}  required={true} type={"text"} placeholder={"Last Name "} className={"border-none bg-[#3C364C] w-1/2 p-2  rounded-md text-sm md:text-base placeholder:text-[#7F7B89]"}/>
                    </div>
                    {/*Age and gender*/}
                    <div className={"flex gap-4 mb-4 md:mb-4 mx-auto w-11/12"}>
                    {/*    Age*/}
                    <input name={"age"} required={true} min={5} max={200} type={"number"} placeholder={"Enter your age"} className={"border-none bg-[#3C364C] w-1/2 p-2  rounded-md text-sm  md:text-base placeholder:text-[#7F7B89]"}/>
                        {/*Gender*/}
                    ...
                    }} defaultValue={""} className={"border-none bg-[#3C364C] w-1/2 p-2  rounded-md text-sm md:text-base  text-[#7F7B89]"}>
                    ...
                    {/*Email*/}
                    <input required={true} type={"email"} name={"Email"} autoComplete={"email"} placeholder={"Email"} className={"border-none block mb-4 md:mb-4 bg-[#3C364C] w-11/12  p-2  md:text-base mx-auto rounded-md text-sm placeholder:text-[#7F7B89]"}/>
                    {/*Password*/}
                    <div className={"border-none block relative mb-3 md:mb-4 bg-[#3C364C] mx-auto w-11/12  rounded-md text-sm md:text-base"}>
                    <input required={true}  type={showPassword ? "text" : "password"} name={"Password"} placeholder={"Password"} className={"border-none block mb-4 md:mb-4  p-2 bg-[#3C364C] w-full  mx-auto md:text-base rounded-md text-sm placeholder:text-[#7F7B89]"}/>
                        {showPassword ?
                    ...
                    <div className={"border-none block relative mb-3 bg-[#3C364C] mx-auto w-11/12  rounded-md text-sm"}>
                        <input required={true}  type={showConfirmPassword ? "text" : "password"} name={"ConfirmPassword"} placeholder={"Confirm your Password"} className={"border-none block mb-3 md:mb-4 p-2  md:text-base     bg-[#3C364C] w-full  mx-auto rounded-md text-sm placeholder:text-[#7F7B89]"}/>
                    ...
                    <div className={"w-11/12 mx-auto "}>
                        <input required={true} type={"checkbox"}  id={"terms"} className={"mr-2 accent-purple-500 md:scale-150 "} />
